# ============================================================================
# proguard-rules.pro (instantapp module)
# ProGuard / R8 rules for the Instant App variant of ET Mini Militia.
#
# Identical to the main app's rules — kept in sync to ensure both variants
# produce equivalent release builds. See app/proguard-rules.pro for detailed
